...
import struct
from common import (MessageHandler, ObexVersion, Response,
                           UnknownResponse)
...
class NotAcceptable(FailureResponse):
...
class ResponseHandler(MessageHandler):
    ...
    def decode_connection(self, socket):
        ...
        obex_version, flags, max_packet_length = struct.unpack(">BBH",
                                                               data[3:7])
        print (obex_version, flags, max_packet_length)
